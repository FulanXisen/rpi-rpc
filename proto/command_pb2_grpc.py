...
class CommandStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExecuteStream = channel.unary_stream(
                '/rpi.command.Command/ExecuteStream',
                request_serializer=command__pb2.CommandRequest.SerializeToString,
                response_deserializer=command__pb2.CommandResponse.FromString,
                )
...
def add_CommandServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'rpi.command.Command', rpc_method_handlers)
...
class Command(object):
    ...
    def Execute(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rpi.command.Command/Execute',
    ...
    def ExecuteStream(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/rpi.command.Command/ExecuteStream',
            command__pb2.CommandRequest.SerializeToString,
            command__pb2.CommandResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
